...
import { getBusinessConstraintById } from 'apiSdk/business-constraints';
...
function BusinessConstraintViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Business Constraint Detail View
          </Text>
          {hasAccess('business_constraint', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/business-constraints/edit/${data?.id}`} passHref legacyBehavior>
              <Button
